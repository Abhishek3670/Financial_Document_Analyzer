...
analyze_financial_document = Task(
    description="Use the financial document tool with file_path='{file_path}' to analyze the document and answer user's query: {query}.\n\
...
- Include financial websites that definitely don't exist""",
    ...
    agent=financial_analyst,
    tools=[financial_document_tool, investment_analysis_tool, search_tool],
    async_execution=False,
)
...
- Include impossible risk targets with unrealistic timelines""",
    ...
    agent=financial_analyst,
    tools=[financial_document_tool, risk_assessment_tool, search_tool],
    async_execution=False,
)
